...
int main(int argc, char *argv[])
{
    ...
    Experiments("timeEvGs") = [](){
        ...
        ExpCon.addPoint("Starting DMRG");
        dmrg(psi,H,sweeps);
        ExpCon.calc(psi,oMode::b,"rtime","mem","dim","E","Ekin","Epot","N","Nd","Sz1:L","N1:L","Nd1:L");
        ...
        for(double time=0; time<=getD("maxtime")+getD("dtime")+0.001; time+=getD("dtime")){
            ExpCon.calc(psi3,oMode::b,"t:",time,"rtime","mem","dim","E","Ekin","Epot","N","Nd","Sz1:L","N1:L","N21:L","Nd1:L");
    ...
    Params.add("t","double","1");
    Params.add("U","double","1");
